        ...
        <div className="w-[90%] lg:w-full text-wrap">
          ...
          <div className="flex py-2 rounded-full  text-xl items-center">
            <span className=" flex items-center gap-1 ">
              <BiLike />
              {!likeCount ? null : (
                <span className="text-base">{formatCount(likeCount)}</span>
              )}
            </span>
            <span className="px-3">
              <BiDislike />
            ...
            {replies?.length > 0 && (
              <h5
                className="font-medium text-base cursor-pointer text-blue-700"
          ...
          <div key={reply.id} className=" p-2 lg:pb-4 lg:pt-0 flex gap-2">
            ...
            <div>
              ...
              <div className="flex py-2 rounded-full  text-xl items-center">
                <span className=" flex items-center gap-1 ">
                  <BiLike />
                  {!reply?.snippet?.likeCount ? null : (
                    <span className="text-base">
                      {formatCount(reply?.snippet?.likeCount)}
                    </span>
                  )}
                </span>
                <span className=" px-3">
