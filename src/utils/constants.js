...
export const FETCH_VIDEOS_BY_KEYWORD = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=10&type=video&key=" + import.meta.env.VITE_YOUTUBE_API_KEY + "&q="
...
export const FETCH_VIDEO_COMMENTS = `https://www.googleapis.com/youtube/v3/commentThreads?part=snippet,replies&key=${import.meta.env.VITE_YOUTUBE_API_KEY}&videoId=`
