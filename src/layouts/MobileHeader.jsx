    ...
    <div className="flex flex-col items-center h-max   w-[100vw] py-2 text-xl px-3 ">
      <div
        className={`flex w-full ${
          showMobileSearchbar ? "justify-between px-2" : "justify-evenly"
        } items-center`}
      >
        ...
        >
          <input
            ...
            autoComplete="off"
            placeholder="Search"
            className="border text-base md:w-full  px-4 py-2 rounded-l-full border-slate-300 border-r-0 focus:outline-none "
          ...
          {searchText && (
            <span
              className="border border-l-0 px-1 flex items-center text-lg py-1 cursor-pointer text-gray-700 "
              onClick={() => setSearchText("")}
            >
              <IoClose />
            </span>
          )}
          <button className="border  bg-gray-200 border-slate-300 rounded-r-full px-2  text-base py-1">
            <FiSearch />
          </button>
        </form>
          ...
          <ul
            className={
              !searchSuggestions?.length
                ...
                : "w-full px-2 py-2 border border-gray-200 bg-white "
            }
          >
            {searchSuggestions &&
