...
const LiveChatContainer = () => {
  ...
  return (
    <div className="w-[20vw] border border-gray-600 rounded-lg h-[600px] mx-6 p-2 pb-0 ">
        <div className="h-[90%] overflow-y-scroll" ref={liveChatContainerRef}>
        ...
        <form className=" h-[10%] bg-white border-t flex gap-2 items-center w-full" onSubmit={handleSubmit} >
            <input type="text" name="liveChat" className="border border-gray-400 px-2 py-1 w-[85%] rounded-xl" value={liveUsersChat} onChange={(e) => setLiveUsersChat(e.target.value)} placeholder="chat as a default user" autoComplete="off" />
